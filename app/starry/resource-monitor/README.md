...
resource-monitoring data for StarryOS application experiments. It is intended for
offline board/QEMU debugging and demo evidence, not for cloud monitoring.
...
not add kernel counters, drivers, or online telemetry services. When a metric is
...
```sh
cd app/starry/resource-monitor/offline-viewer
...
```text
test-suit/starryos/normal/qemu-smp1/offline-monitor/
```
